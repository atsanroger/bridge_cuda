                           ...
                           std::string filename)
{
  ...
  write_testvectors(fopr_d, TDa, testvectors_d, Nk, coarse_lattice,
                    file_base);
...
void write_testvectors(AFopr<AFIELD>* fopr,
...
//====================================================================
template<typename AFIELD>
void read_testvectors(AFopr<AFIELD>* fopr,
                      std::vector<COMPLEX_t>& TDa,
                      std::vector<AFIELD>& testvectors,
                      std::vector<int>& coarse_lattice,
                      std::string filename)
...
//====================================================================
template<typename AFIELD>
void check_eigen_testvectors(AFopr_dd<AFIELD>* fopr,
                             std::vector<COMPLEX_t>& TDa,
                             std::vector<AFIELD>& testvectors,
                             std::vector<int>& coarse_lattice)
{
  ...
  vout.general(vl, "# eigenvalue distribution\n");
  for(int ik = 0; ik < Nk; ++ik){
    int block = 0;
    int idx = block + Nblock * ik;
    vout.general(vl, "  %14.6e  %14.6e\n", real(TDa[idx]), imag(TDa[idx]));
  }
  vout.general(vl, "\n");
