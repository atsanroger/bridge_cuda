...
int Test_Coarse::test()
{
  ...
  // setting testvectors with blocked eigensolver (double)
  {
    ...
    //string filename = "testvector";
    //string filename = "data/testvector_prec";
    ...
    //- read eigenvectors and set to testvectors
    // read_testvectors(afopr_fineF, TDa, testvectors, coarse_lattice,
    //                 filename);
    // check_eigen_testvectors(afopr_fineF, TDa, testvectors, coarse_lattice);

    read_testvectors(afopr_fineF, TDa, atestvec, coarse_lattice,
                     filename_base);
    
    check_eigen_testvectors(afopr_fineF, TDa, atestvec, coarse_lattice);
