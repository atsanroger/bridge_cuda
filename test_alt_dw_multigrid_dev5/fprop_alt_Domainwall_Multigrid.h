/*!
      @file    fprop_alt_Domainwall_Multigrid.h
      @brief
...
class Fprop_alt_Domainwall_Multigrid : public Fprop_alt<AFIELD>
{
 public:
 ...
 public:
  Fprop_alt_Domainwall_Multigrid(const Parameters& params_fopr,
  ...
  ~Fprop_alt_Domainwall_Multigrid()
  { tidyup(); }
