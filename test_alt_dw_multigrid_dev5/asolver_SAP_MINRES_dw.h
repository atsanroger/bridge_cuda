...
#ifndef ASOLVER_SAP_MINRES_DW_H
#define ASOLVER_SAP_MINRES_DW_H
...
class ASolver_SAP_MINRES_dw : public ASolver<AFIELD>
{
 public:
 ...
 public:
  //! constructor.
  ASolver_SAP_MINRES_dw(AFopr_dd<AFIELD> *fopr, const block_index_t *block_index)
  ...
  ASolver_SAP_MINRES_dw(AFopr<AFIELD> *fopr)
    : m_Niter(0), m_Stop_cond(-1.0)
  {
    vout.crucial(m_vl, "partial construct is not allowed for Asolver_SAP_MINRES_dw\n");
    abort();
    m_fopr        = nullptr;
  ...
  //! destructor.
  ~ASolver_SAP_MINRES_dw() { this->tidyup(); }
 ...
 private:
  ...
  {
    return new ASolver_SAP_MINRES_dw<AFIELD>(afopr);
  }

 public:
  static bool register_factory()
  {
    return ASolver<AFIELD>::Factory_fopr::Register("SAP_MINRES_dw_dw", create_object);
  }
#endif
};
