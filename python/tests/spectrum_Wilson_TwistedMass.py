...
solver_param=dict(
    ...
    torelance_for_DynamicSelection_of_L=0.1
)


fopr1=Fopr_Smeared(Fopr_Wilson_TwistedMass(gamma_matrix_type="Dirac",
...
pp1=calc_prop(
    fopr1,
    Solver("BiCGStab_L_Cmplx", fopr1, **solver_param),
    Source("Local",
           source_position=[0,0,0,0]
    )
)

fopr2=Fopr_Smeared(Fopr_Wilson_TwistedMass(gamma_matrix_type="Dirac",
...
pp2=calc_prop(
    fopr2,
    Solver("BiCGStab_L_Cmplx", fopr2, **solver_param),
    Source("Exponential",
           source_position=[0,0,0,0],
           slope=0.50,
           power=2.0
