...
fopr=Fopr_Clover(**fopr_params)
force_fopr=Force_F_Clover_Nf2(**fopr_params)
...
fopr_eo=Fopr_Clover_eo(**fopr_params)
fopr_smear_eo=Fopr_Smeared_eo(fopr_eo, dr_smear)

solver_eo_md=Solver_BiCGStab_L_Cmplx(fopr_smear_eo,
...
fprop_eo_md=Fprop_Standard_eo(solver_eo_md)

solver_eo_h=Solver_BiCGStab_L_Cmplx(fopr_smear_eo,
                                    maximum_number_of_iteration=100,
                                    maximum_number_of_restart=40,
                                    convergence_criterion_squared=1.0e-28,
                                    use_initial_guess="false",
                                    ...
                                    number_of_orthonormal_vectors=2,
                                    tolerance_for_DynamicSelection_of_L=0.1)
fprop_eo_h=Fprop_Standard_eo(solver_eo_h)
...
action_f=Action_F_Standard_eo(fopr_smear, force_fopr_smear,
