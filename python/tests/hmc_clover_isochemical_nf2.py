...
fopr=Fopr_Clover_Isochemical(**fopr_params)
force_fopr=Force_F_Clover_Nf2_Isochemical(**fopr_params)
...
rand_v=RandomNumbers("Mseries", seed=200000)
noise=NoiseVector_Z2(rand_v)

qsuscept=QuarkNumberSusceptibility_Wilson(fopr_smear, fprop_h, noise,
                                          number_of_noises=10)
...
for traj in range(ntraj):
    ...
    ploop = ploop.measure(u)
    print("Polyakov loop = {}\n".format(ploop))

    suscept=qsuscept.measure()
