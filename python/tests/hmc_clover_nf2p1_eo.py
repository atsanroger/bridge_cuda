...
fopr_nf2_params=dict(type="Clover",
                     gamma_matrix_type="Dirac",
                     hopping_parameter=0.13,
                     clover_coefficient=1.0,
                     boundary_condition=[1,1,1,-1])

fopr_nf2=Fopr_Clover(**fopr_nf2_params)
force_fopr_nf2=Force_F_Clover_Nf2(**fopr_nf2_params)
...
fopr_nf2_eo=Fopr_Clover_eo(**fopr_nf2_params)
fopr_smear_nf2_eo=Fopr_Smeared_eo(fopr_nf2_eo, dr_smear)

solver_nf2_eo_md=Solver(type="BiCGStab_L_Cmplx",
                        op=fopr_smear_nf2_eo,
                        maximum_number_of_iteration=100,
                        convergence_criterion_squared=1.0e-28,
                        **solver_param_base)
fprop_nf2_eo_md=Fprop_Standard_eo(solver_nf2_eo_md)

solver_nf2_eo_h=Solver(type="BiCGStab_L_Cmplx",
                       op=fopr_smear_nf2_eo,
                       maximum_number_of_iteration=100,
                       convergence_criterion_squared=1.0e-28,
                       **solver_param_base)
fprop_nf2_eo_h=Fprop_Standard_eo(solver_nf2_eo_h)


#-- Nf=2 part preconditioner

fopr_nf2_prec_params=dict(type="Clover",
                          gamma_matrix_type="Dirac",
                          hopping_parameter=0.11,
                          clover_coefficient=1.0,
                          boundary_condition=[1,1,1,-1])

fopr_nf2_prec=Fopr_Clover(**fopr_nf2_prec_params)
force_fopr_nf2_prec=Force_F_Clover_Nf2(**fopr_nf2_prec_params)
...
fopr_nf2_eo_prec=Fopr_Clover_eo(**fopr_nf2_prec_params)
fopr_smear_nf2_eo_prec=Fopr_Smeared_eo(fopr_nf2_eo_prec, dr_smear)

solver_nf2_eo_md_prec=Solver(type="BiCGStab_L_Cmplx",
                             op=fopr_smear_nf2_eo_prec,
                             maximum_number_of_iteration=100,
                             convergence_criterion_squared=1.0e-28,
                             **solver_param_base)
fprop_nf2_eo_md_prec=Fprop_Standard_eo(solver_nf2_eo_md_prec)

solver_nf2_eo_h_prec=Solver(type="BiCGStab_L_Cmplx",
                            op=fopr_smear_nf2_eo_prec,
                            maximum_number_of_iteration=100,
                            convergence_criterion_squared=1.0e-28,
                            **solver_param_base)
fprop_nf2_eo_h_prec=Fprop_Standard_eo(solver_nf2_eo_h_prec)
...
action_f_nf2_prec=Action_F_Standard_eo(
    fopr_smear_nf2_prec, force_fopr_smear_nf2_prec,
    fprop_nf2_eo_md_prec, fprop_nf2_eo_h_prec)

action_f_nf2_d=Action_F_Ratio_eo(
    fopr_smear_nf2_prec, force_fopr_smear_nf2_prec,
    fopr_smear_nf2, force_fopr_smear_nf2,
    fprop_nf2_eo_h_prec,
...
fopr_nf1_params=dict(type="Clover",
                     gamma_matrix_type="Dirac",
...
fopr_nf1=Fopr_Clover(**fopr_nf1_params)
force_fopr_nf1=Force_F_Clover_Nf2(**fopr_nf1_params)
