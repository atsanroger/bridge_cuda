...
fopr=Fopr_Wilson_TwistedMass(**fopr_params)
force_fopr=Force_F_Wilson_TwistedMass_Nf2(**fopr_params)

solver_md=Solver_BiCGStab_L_Cmplx(fopr,
...
solver_h=Solver_BiCGStab_L_Cmplx(fopr,
                                 maximum_number_of_iteration=100,
                                 maximum_number_of_restart=40,
                                 convergence_criterion_squared=1.0e-28,
                                 use_initial_guess="false",
...
action_f=Action_F_Standard_lex(fopr, force_fopr, fprop_md, fprop_h)
