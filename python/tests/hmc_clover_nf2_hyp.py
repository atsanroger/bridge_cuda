...
smear_params=dict(alpha1=0.95, alpha2=0.76, alpha3=0.38)

proj=Projection_Stout_SU3()
smear=Smear_HYP(proj, **smear_params)
dr_smear=Director_Smear(smear, number_of_smearing=1)

smearforce=ForceSmear_HYP(proj, **smear_params)
