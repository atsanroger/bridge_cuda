...
#ifndef ASOLVER_SAP_MINRES_DW2_H
#define ASOLVER_SAP_MINRES_DW2_H
...
class ASolver_SAP_MINRES_dw2 : public ASolver<AFIELD>
{
 public:
 ...
 public:
  //! constructor.
  ASolver_SAP_MINRES_dw2(AFopr_dd<AFIELD> *fopr, const block_index_t *block_index)
  ...
  ASolver_SAP_MINRES_dw2(AFopr<AFIELD> *fopr)
    : m_Niter(0), m_Stop_cond(-1.0)
  {
    vout.crucial(m_vl, "partial construct is not allowed for Asolver_SAP_MINRES_dw2\n");
    abort();
    m_fopr        = nullptr;
  ...
  //! destructor.
  ~ASolver_SAP_MINRES_dw2() { this->tidyup(); }
  ...
  void set_PV_solver(ASolver<AFIELD> *PV_solver) {
    m_PV_solver = PV_solver;
  }
 ...
 private:
  ...
  {
    return new ASolver_SAP_MINRES_dw2<AFIELD>(afopr);
  }

 public:
  static bool register_factory()
  {
    return ASolver<AFIELD>::Factory_fopr::Register("SAP_MINRES_dw2_dw", create_object);
  }
#endif
};

#endif // ASOLVER_SAP_MINRES_DW_H
