...
#include "lib_alt_SIMD2/bridge_alt_simd2.h"
#define IMPL SIMD2
...
int Test_alt_SIMD2::test_all()
{
  ...
  vout.general("Test result for SIMD2 = %d\n", result);
  return result;
}

//====================================================================
int Test_alt_SIMD2::test_Spectrum_Wilson()
{
...
//====================================================================
int Test_alt_SIMD2::test_Spectrum_Clover()
{
  Spectrum_Wilson_alt<IMPL> test_wilson;
...
//====================================================================
int Test_alt_SIMD2::test_Spectrum_Domainwall()
{
  ...
  // test_dw.hadron_2ptFunction(test_file, "float"); //ok

  // unchecked:
  // test_dw.hadron_2ptFunction(test_file, "mixed"); not existing
  return result;
}

//====================================================================
int Test_alt_SIMD2::test_Spectrum_Domainwall_5din()
{
  Spectrum_Domainwall_alt<IMPL> test_dw;
  ...
  // unchecked:
  //result += test_dw.hadron_2ptFunction(test_file, "org");
  /*
  result += test_dw.hadron_2ptFunction(test_file, "double_prec");
...
//====================================================================
int Test_alt_SIMD2::test_Spectrum_OptimalDomainwall()
{
  Spectrum_Domainwall_alt<IMPL> test_dw;
...
//====================================================================
int Test_alt_SIMD2::test_Spectrum_Staggered()
{
  ...
  */
  ...
  // test_staggered.hadron_2ptFunction(test_file, "float", run_mode);
...
//====================================================================
int Test_alt_SIMD2::test_Spectrum_LinearAlgebra()
{
...
//====================================================================
int Test_alt_SIMD2::test_Eigenvalue_Wilson_Lanczos()
{
...
//====================================================================
int Test_alt_SIMD2::test_Eigenvalue_Wilson_Arnoldi()
{
  //Eigenvalue_alt<IMPL> test_wilson;
  Eigenvalue_alt<AField<double, IMPL> > test_wilson;
...
//====================================================================
int Test_alt_SIMD2::test_Eigenvalue_Staggered_Lanczos()
{
...
//====================================================================
int Test_alt_SIMD2::test_Eigenvalue_Staggered_Arnoldi()
{
  //Eigenvalue_alt<IMPL> test_staggered;
  Eigenvalue_alt<AField<double, IMPL> > test_staggered;
...
//====================================================================
int Test_alt_SIMD2::test_Spectrum_AdjointWilson_Lanczos()
{
...
//====================================================================
int Test_alt_SIMD2::test_Eigenvalue_AdjointWilson_Lanczos()
{
  Spectrum_AdjointWilson_alt<IMPL> test_wilson;
