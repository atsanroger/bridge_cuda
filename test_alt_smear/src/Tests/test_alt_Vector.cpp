...
#include "lib_alt_Vector/bridge_alt_openacc.h"
#define IMPL VECTOR
...
int Test_alt_Vector::test_all()
{
  ...
  vout.general("Test result for Vector = %d\n", result);
  return result;
}

//====================================================================
int Test_alt_Vector::test_Spectrum_Wilson()
{
...
//====================================================================
int Test_alt_Vector::test_Spectrum_Clover()
{
  Spectrum_Wilson_alt<IMPL> test_wilson;
...
//====================================================================
int Test_alt_Vector::test_Spectrum_OptimalDomainwall()
{
...
//====================================================================
int Test_alt_Vector::test_Spectrum_Staggered()
{
  ...
  int result = 0;
  result += test_staggered.hadron_2ptFunction(test_file, "double");
...
//====================================================================
int Test_alt_Vector::test_Spectrum_Domainwall()
{
  Spectrum_Domainwall_alt<IMPL> test_dw;
...
//====================================================================
int Test_alt_Vector::test_Spectrum_Domainwall_5din()
{
  Spectrum_Domainwall_alt<IMPL> test_dw;
...
//====================================================================
int Test_alt_Vector::test_Spectrum_LinearAlgebra()
{
...
//====================================================================
int Test_alt_Vector::test_Eigenvalue_Wilson_Lanczos()
{
...
//====================================================================
int Test_alt_Vector::test_Eigenvalue_Wilson_Arnoldi()
{
  Eigenvalue_alt<IMPL> test_wilson;
...
//====================================================================
int Test_alt_Vector::test_Eigenvalue_Staggered_Lanczos()
{
...
//====================================================================
int Test_alt_Vector::test_Eigenvalue_Staggered_Arnoldi()
{
  Eigenvalue_alt<IMPL> test_staggered;
...
//====================================================================
int Test_alt_Vector::test_Spectrum_AdjointWilson_Lanczos()
{
...
//====================================================================
int Test_alt_Vector::test_Eigenvalue_AdjointWilson_Lanczos()
{
  Spectrum_AdjointWilson_alt<IMPL> test_wilson;
