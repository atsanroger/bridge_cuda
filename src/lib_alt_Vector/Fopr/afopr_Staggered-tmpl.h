...
void AFopr_Staggered<AFIELD>::init(const Parameters& params)
{
  ...
  int Nst = Nx * Ny * Nz * Nt;
  if(Nst % VLEN != 0){
    vout.crucial(m_vl, "%s: lattice size is not a multiple of VLEN = %d\n",
                 class_name.c_str(), VLEN);
    exit(EXIT_FAILURE);
  }
...
void AFopr_Staggered<AFIELD>::set_config(Field *U)
{
  ...
  BridgeVec::mult_staggered_phase_dev(up, stgph, m_Nsize, NC);
...
void AFopr_Staggered<AFIELD>::D(AFIELD& v, const AFIELD& w)
{
  ...
  if(do_comm_any > 0){
    ...
    BridgeVec::mult_staggered_1(buf1xp, buf1xm, buf1yp, buf1ym,
                                buf1zp, buf1zm, buf1tp, buf1tm,
                                up, wp, m_Nsize, m_bc, do_comm);
    ...
    BridgeVec::mult_staggered_D(vp, up, wp, m_Nsize, m_bc2, m_mq, jd);
  ...
  if(do_comm_any > 0){
    ...
    BridgeVec::mult_staggered_2(vp, up,
                     buf2xp, buf2xm, buf2yp, buf2ym,
                     buf2zp, buf2zm, buf2tp, buf2tm,
                     m_Nsize, m_bc, do_comm, m_mq, jd);
...
{
  BridgeVec::mult_staggered_clear(v2, m_Nsize, NC);
...
{
  BridgeVec::mult_staggered_aypx(a, v2, v1, m_Nsize, NC);
...
{
  BridgeVec::mult_staggered_scal(v, a, m_Nsize, NC);
...
void AFopr_Staggered<AFIELD>::mult_xp(real_t *v2, real_t *v1)
{
  ...
  if(do_comm[idir] > 0){
    ...
    BridgeVec::mult_staggered_xp1(buf1, v1, m_Nsize, m_bc, NC);
  ...
  BridgeVec::mult_staggered_xpb(v2, u, v1, m_Nsize, m_bc2, NC);

  if(do_comm[idir] > 0){
    BridgeVec::mult_staggered_xp2(v2, u, buf2, m_Nsize, m_bc, NC);
  }
...
void AFopr_Staggered<AFIELD>::mult_xm(real_t *v2, real_t *v1)
{
  ...
  if(do_comm[idir] > 0){
    ...
    BridgeVec::mult_staggered_xm1(buf1, u, v1, m_Nsize, m_bc, NC);
  ...
  BridgeVec::mult_staggered_xmb(v2, u, v1, m_Nsize, m_bc2, NC);

  if(do_comm[idir] > 0){
    BridgeVec::mult_staggered_xm2(v2, buf2, m_Nsize, m_bc, NC);
  }
...
void AFopr_Staggered<AFIELD>::mult_yp(real_t *v2, real_t *v1)
{
  ...
  if(do_comm[idir] > 0){
    ...
    BridgeVec::mult_staggered_yp1(buf1, v1, m_Nsize, m_bc, NC);
  ...
  BridgeVec::mult_staggered_ypb(v2, u, v1, m_Nsize, m_bc2, NC);

  if(do_comm[idir] > 0){
    BridgeVec::mult_staggered_yp2(v2, u, buf2, m_Nsize, m_bc, NC);
  }
...
void AFopr_Staggered<AFIELD>::mult_ym(real_t *v2, real_t *v1)
{
  ...
  if(do_comm[idir] > 0){
    ...
    BridgeVec::mult_staggered_ym1(buf1, u, v1, m_Nsize, m_bc, NC);
  ...
  BridgeVec::mult_staggered_ymb(v2, u, v1, m_Nsize, m_bc2, NC);

  if(do_comm[idir] > 0){
    BridgeVec::mult_staggered_ym2(v2, buf2, m_Nsize, m_bc, NC);
  }
...
void AFopr_Staggered<AFIELD>::mult_zp(real_t *v2, real_t *v1)
{
  ...
  if(do_comm[idir] > 0){
    ...
    BridgeVec::mult_staggered_zp1(buf1, v1, m_Nsize, m_bc, NC);
  ...
  BridgeVec::mult_staggered_zpb(v2, u, v1, m_Nsize, m_bc2, NC);

  if(do_comm[idir] > 0){
    BridgeVec::mult_staggered_zp2(v2, u, buf2, m_Nsize, m_bc, NC);
  }
...
void AFopr_Staggered<AFIELD>::mult_zm(real_t *v2, real_t *v1)
{
  ...
  if(do_comm[idir] > 0){
    ...
    BridgeVec::mult_staggered_zm1(buf1, u, v1, m_Nsize, m_bc, NC);
  ...
  BridgeVec::mult_staggered_zmb(v2, u, v1, m_Nsize, m_bc2, NC);

  if(do_comm[idir] > 0){
    BridgeVec::mult_staggered_zm2(v2, buf2, m_Nsize, m_bc, NC);
  }
...
void AFopr_Staggered<AFIELD>::mult_tp(real_t *v2, real_t *v1)
{
  ...
  if(do_comm[idir] > 0){
    ...
    BridgeVec::mult_staggered_tp1(buf1, v1, m_Nsize, m_bc, NC);
  ...
  BridgeVec::mult_staggered_tpb(v2, u, v1, m_Nsize, m_bc2, NC);

  if(do_comm[idir] > 0){
    BridgeVec::mult_staggered_tp2(v2, u, buf2, m_Nsize, m_bc, NC);
  }
...
void AFopr_Staggered<AFIELD>::mult_tm(real_t *v2, real_t *v1)
{
  ...
  if(do_comm[idir] > 0){
    ...
    BridgeVec::mult_staggered_tm1(buf1, u, v1, m_Nsize, m_bc, NC);
  ...
  BridgeVec::mult_staggered_tmb(v2, u, v1, m_Nsize, m_bc2, NC);

  if(do_comm[idir] > 0){
    BridgeVec::mult_staggered_tm2(v2, buf2, m_Nsize, m_bc, NC);
  }
