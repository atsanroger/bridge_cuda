...
template<>
const std::string Fprop_alt_Standard_eo_Mixedprec<AField<double,VECTOR>, AField<float,VECTOR> >::class_name
  = "Fprop_alt_Standard_eo_Mixedprec<AField<double,VECTOR>, AField<float,VECTOR> >";

// class instanciation
template class Fprop_alt_Standard_eo_Mixedprec<AField<double,VECTOR>, AField<float,VECTOR> >;
