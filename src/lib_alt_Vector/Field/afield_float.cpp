...
template<>
const std::string AField<float, VECTOR>::class_name = "AField<float, VECTOR>";


// explicit instanciation.
template class AField<float, VECTOR>;

// copy between fields with different precisions.
//====================================================================
void copy(AField<float, VECTOR>& v, const AField<float, VECTOR> &w)
{
