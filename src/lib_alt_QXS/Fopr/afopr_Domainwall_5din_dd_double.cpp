...
namespace {
  ...
  {
    return new AFopr_Domainwall_5din_dd<AField<double, QXS> >(params);
  }
...
template<>
const std::string AFopr_Domainwall_5din_dd<AField<double, QXS> >
::class_name = "AFopr_Domainwall_5din_dd<AField<double,QXS> >";

template class AFopr_Domainwall_5din_dd<AField<double, QXS> >;
