/*!
      @file    afopr_Domainwall_5din_half.h
      @brief
...
namespace {
  ...
  {
    return new AFopr_Domainwall_5din<AField<half, QXS> >(params);
  }
...
template<>
const std::string AFopr_Domainwall_5din<AField<half, QXS> >
::class_name = "AFopr_Domainwall_5din<AField<half,QXS> >";

template class AFopr_Domainwall_5din<AField<half, QXS> >;
