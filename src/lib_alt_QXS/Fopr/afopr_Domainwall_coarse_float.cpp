/*!
      @file    afopr_Domainwall_coarse_float.cpp
      @brief
...
#include "afopr_Domainwall_coarse.h"
...
//#include "lib_alt_QXS/BridgeQXS/bridgeQXS_Domainwall_coarse.h"

// template definition
//#include "lib_alt_QXS/Fopr/afopr_Domainwall_coarse-tmpl.h"
#include "afopr_Domainwall_coarse-tmpl.h"

template<>
const std::string AFopr_Domainwall_coarse<AField<float, QXS> >::class_name
  = "AFopr_Domainwall_coarse<AField<float,QXS> >";
...
template class AFopr_Domainwall_coarse<AField<float, QXS> >;
