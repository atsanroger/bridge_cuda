/*!
      @file    afopr_CloverTerm_float.cpp
      @brief
...
template<>
const std::string AFopr_CloverTerm<AField<float, QXS> >::class_name
  = "AFopr_CloverTerm<AField<float,QXS> >";
...
template class AFopr_CloverTerm<AField<float, QXS> >;
