...
#ifndef QXS_AFOPR_CLOVERTERM_INCLUDED
#define QXS_AFOPR_CLOVERTERM_INCLUDED
...
/*!
  Implementation of the clover term fermion operator (lexical
  index) in the QXS branch.
                                      [14 Oct 2023 H.Matsufuru]
*/
...
class AFopr_CloverTerm : public AFopr<AFIELD>
{
 ...
 public:
  //! constructor.
  AFopr_CloverTerm(const Parameters& params) : AFopr<AFIELD>()
  { init(params); }
  ...
  void mult_isigma(AFIELD& v, const AFIELD& w,
 ...
 private:
  ...
  void mult_gm12(real_t*, const real_t*, const real_t);
  void mult_gm23(real_t*, const real_t*, const real_t);
  void mult_gm31(real_t*, const real_t*, const real_t);
  void mult_gm14_dirac(real_t*, const real_t*, const real_t);
  void mult_gm24_dirac(real_t*, const real_t*, const real_t);
  void mult_gm34_dirac(real_t*, const real_t*, const real_t);
  void mult_gm14_chiral(real_t*, const real_t*, const real_t);
  void mult_gm24_chiral(real_t*, const real_t*, const real_t);
  void mult_gm34_chiral(real_t*, const real_t*, const real_t);
 ...
 public:
  ...
  {
    bool init1 = AFopr<AFIELD>::Factory_params::Register("CloverTerm",
