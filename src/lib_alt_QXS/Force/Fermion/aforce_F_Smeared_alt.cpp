...
template<>
const std::string AForce_F_Smeared_alt<AField<double,QXS> >::class_name
                         = "AForce_F_Smeared_alt<AField<double,QXS> >";


template class AForce_F_Smeared_alt<AField<double,QXS> >;
