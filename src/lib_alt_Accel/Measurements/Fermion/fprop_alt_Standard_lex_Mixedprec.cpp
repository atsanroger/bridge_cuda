...
template<>
const std::string Fprop_alt_Standard_lex_Mixedprec<AField<double,ACCEL>, AField<float,ACCEL> >::class_name
 = "Fprop_alt_Standard_lex_Mixedprec<AField<double,ACCEL>, AField<float,ACCEL> >";

// class instanciation
template class Fprop_alt_Standard_lex_Mixedprec<AField<double,ACCEL>, AField<float,ACCEL> >;
