/*!  Auto-generated from mult_Domainwall_eo_openacc2_t_dirac-inc.h for shared-memory gauge link sharing.
     Requires: u_sh, lane, is_local in scope; SU3_3RD_ROW_RECONST defined. */
/*!
      @file    mult_Wilson_eo_openacc2_t_dirac-inc.h
      @brief
      @author  Kanamori (kanamori)
      @date    $LastChangedDate: 2024-05-07 13:51:53 #$
...

{
      ...
      int isg = ixyz + it*Nx*Ny*Nz + Nst*(ieo + 2*idir);
