/*!
      @file    afopr_Wilson_dd_float.cpp
      @brief
...
template<>
const std::string AFopr_Wilson_dd<AField<float,ACCEL> >::class_name
                            = "AFopr_Wilson_dd<AField<float,ACCEL> >";
...
template class AFopr_Wilson_dd<AField<float,ACCEL> >;
