...
template<>
const std::string AFopr_Domainwall_coarse<AField<float,ACCEL> >::class_name
                      = "AFopr_Domainwall_coarse<AField<float,ACCEL> >";
...
template class AFopr_Domainwall_coarse<AField<float,ACCEL> >;
