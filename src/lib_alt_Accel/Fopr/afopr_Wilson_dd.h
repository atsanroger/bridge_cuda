...
#ifndef ACCEL_AFOPR_WILSON_DD_INCLUDED
#define ACCEL_AFOPR_WILSON_DD_INCLUDED
...
class AFopr_Wilson_dd : public AFopr_dd<AFIELD>
{
 public:
...
public:
  ...
  //! constructor.
  AFopr_Wilson_dd(const Parameters& params){
    init(params);
    //set_parameters(params);
  }

  //! destructor.
  ~AFopr_Wilson_dd(){ tidyup(); }
 ...
 private:
  ...
  { return new AFopr_Wilson_dd(params); }

 public:
  static bool register_factory()
  {
    bool init1 = AFopr<AFIELD>::Factory_params::Register("Wilson_dd",
...
#endif  // ACCEL_AFOPR_WILSON_DD_INCLUDED
