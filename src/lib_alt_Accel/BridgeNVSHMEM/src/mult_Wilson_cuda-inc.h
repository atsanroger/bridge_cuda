                         ...
                         int *Nsize, int *bc, int *do_comm, int Nc)
{
  ...
  if(do_comm[0] > 0){
    ...
    int nth = VECTOR_LENGTH;
    int nbl = size/nth;
    mult_wilson_1x_kernel<<<nbl,nth>>>(buf_xp_dev, buf_xm_dev,
                                       u_dev, v1_dev,
                                       Nx, Ny, Nz, Nt, bc_x);
  }
  ...
  if(do_comm[1] > 0){
    ...
    int nth = VECTOR_LENGTH;
    int nbl = size/nth;
    mult_wilson_1y_kernel<<<nbl,nth>>>(buf_yp_dev, buf_ym_dev,
                                       u_dev, v1_dev,
                                       Nx, Ny, Nz, Nt, bc_y);
  }
  ...
  if(do_comm[2] > 0){
    ...
    int nth = VECTOR_LENGTH;
    int nbl = size/nth;
    mult_wilson_1z_kernel<<<nbl,nth>>>(buf_zp_dev, buf_zm_dev,
                                       u_dev, v1_dev,
                                       Nx, Ny, Nz, Nt, bc_z);
  }
