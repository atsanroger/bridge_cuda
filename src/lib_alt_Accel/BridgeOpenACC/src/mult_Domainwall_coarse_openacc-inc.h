/*!
      @file    mult_Domainwall_coarse_openacc-inc.h
      @brief
...
//====================================================================
void mult_domainwall_coarse_mult_gm5(real_t *restrict v2,
                                 real_t *restrict v1,
                                 int Ncol, int *Nsize)
{
  int Nx = Nsize[0];
...
#pragma acc data present(v1[0:Nvst], u[0:Ngst], v2[0:Nvst]) \
...
#pragma acc data present(v1[0:Nvst], ct[0:Nctst], v2[0:Nvst]) \
                 copyin(Ncol, Nx, Ny, Nz, Nt, Nst)
