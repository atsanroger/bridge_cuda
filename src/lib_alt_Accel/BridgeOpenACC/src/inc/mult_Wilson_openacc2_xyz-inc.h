/*!
      @file    mult_Wilson_openacc2_xyz-inc.h
      @brief
...
//                                    [13 Jun 2019 H.Matsufuru]
      ...
      // ic = 0;
     {
      ...
      isg = ix + iy*Nx + izt*Nx*Ny + idir*Nst;
      ...
      isn = ix + nn*Nx + izt*Nx*Ny;
      isg = ix + nn*Nx + izt*Nx*Ny + idir*Nst;
      ...
      isg = ixy + iz*Nx*Ny + it*Nx*Ny*Nz + idir*Nst;
      ...
      isn = ixy + nn*Nx*Ny + it*Nx*Ny*Nz;
      isg = ixy + nn*Nx*Ny + it*Nx*Ny*Nz + idir*Nst;
