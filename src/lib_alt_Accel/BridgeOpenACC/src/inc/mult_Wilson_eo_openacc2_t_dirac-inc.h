/*!
      @file    mult_Wilson_eo_openacc2_t_dirac-inc.h
      @brief
...
*/
      ...
      isg = ixyz + it*nx*ny*nz + nst*(ieo + 2*idir);

      vt1_0 = 2.0 * v1[IDX2_SP_R(0,2,isn)];
      vt1_1 = 2.0 * v1[IDX2_SP_I(0,2,isn)];
      vt1_2 = 2.0 * v1[IDX2_SP_R(1,2,isn)];
      vt1_3 = 2.0 * v1[IDX2_SP_I(1,2,isn)];
      vt1_4 = 2.0 * v1[IDX2_SP_R(2,2,isn)];
      vt1_5 = 2.0 * v1[IDX2_SP_I(2,2,isn)];

      vt2_0 = 2.0 * v1[IDX2_SP_R(0,3,isn)];
      vt2_1 = 2.0 * v1[IDX2_SP_I(0,3,isn)];
      vt2_2 = 2.0 * v1[IDX2_SP_R(1,3,isn)];
      vt2_3 = 2.0 * v1[IDX2_SP_I(1,3,isn)];
      vt2_4 = 2.0 * v1[IDX2_SP_R(2,3,isn)];
      vt2_5 = 2.0 * v1[IDX2_SP_I(2,3,isn)];
      ...
      isn = ixyz + nn*nx*ny*nz;
      isg = ixyz + nn*nx*ny*nz + nst*(1-ieo + 2*idir);

      vt1_0 = 2.0 * v1[IDX2_SP_R(0,0,isn)];
      vt1_1 = 2.0 * v1[IDX2_SP_I(0,0,isn)];
      vt1_2 = 2.0 * v1[IDX2_SP_R(1,0,isn)];
      vt1_3 = 2.0 * v1[IDX2_SP_I(1,0,isn)];
      vt1_4 = 2.0 * v1[IDX2_SP_R(2,0,isn)];
      vt1_5 = 2.0 * v1[IDX2_SP_I(2,0,isn)];

      vt2_0 = 2.0 * v1[IDX2_SP_R(0,1,isn)];
      vt2_1 = 2.0 * v1[IDX2_SP_I(0,1,isn)];
      vt2_2 = 2.0 * v1[IDX2_SP_R(1,1,isn)];
      vt2_3 = 2.0 * v1[IDX2_SP_I(1,1,isn)];
      vt2_4 = 2.0 * v1[IDX2_SP_R(2,1,isn)];
      vt2_5 = 2.0 * v1[IDX2_SP_I(2,1,isn)];
