/*!
        @file    bridge_init_factory_alt_SIMD2.cpp
        @brief
...
#include "bridge_init_factory_alt_SIMD2.h"
...
bool bridge_init_factory_alt_SIMD2()
{
  ...
  result &= AFopr<AField<double,SIMD2> >::init_factory();
  result &= ASolver<AField<double,SIMD2> >::init_factory();
  // result &= AForce_F<AField<double,SIMD2> >::init_factory();

  result &= AFopr<AField<float,SIMD2> >::init_factory();
  result &= ASolver<AField<float,SIMD2> >::init_factory();
