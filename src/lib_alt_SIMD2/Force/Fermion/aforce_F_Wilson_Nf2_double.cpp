/*!
        @file    aforce_F_Wilson_Nf2_double.cpp
        @brief
...
#include "lib_alt_SIMD2/Force/Fermion/aforce_F_Wilson_Nf2-tmpl.h"


// explicit instanciation for AField<double,SIMD2>.
template<>
const std::string AForce_F_Wilson_Nf2<AField<double,SIMD2> >::class_name
= "AForce_F_Wilson_Nf2<Afield<double,SIMD2> >";

#ifdef USE_FACTORY_AUTOREGISTER
namespace {
  bool init1 = AForce_F_Wilson_Nf2<AField<double,SIMD2> >::register_factory();
}
#endif

template class AForce_F_Wilson_Nf2<AField<double,SIMD2> >;
