...
template<>
const std::string AStaple_lex<AField<float,SIMD2> >::class_name
                              = "AStaple_lex<AField<float,SIMD2> >";

// explicit instanciation.
template class AStaple_lex<AField<float,SIMD2> >;
