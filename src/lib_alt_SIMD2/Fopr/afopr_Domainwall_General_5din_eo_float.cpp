/*!
      @file    afopr_Domainwall_General_5din_eo_float.h
      @brief
...
namespace {
  ...
  {
    return new AFopr_Domainwall_General_5din_eo<AField<float,SIMD2> >(params);
  }
...
template<>
const std::string AFopr_Domainwall_General_5din_eo<AField<float,SIMD2> >
  ::class_name = "AFopr_Domainwall_General_5din_eo<AField<float,SIMD2> >";

// explicit instanciation
template class AFopr_Domainwall_General_5din_eo<AField<float,SIMD2> >;
