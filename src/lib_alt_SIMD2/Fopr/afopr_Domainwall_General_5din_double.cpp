/*!
      @file    afopr_Domainwall_General_5din_double.h
      @brief
...
template<>
const std::string AFopr_Domainwall_General_5din<AField<double,SIMD2> >
  ::class_name = "AFopr_Domainwall_General_5din<AField<double,SIMD2> >";
...
template class AFopr_Domainwall_General_5din<AField<double,SIMD2> >;
