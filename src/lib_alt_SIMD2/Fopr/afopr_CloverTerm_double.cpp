...
template<>
const std::string AFopr_CloverTerm<AField<double,SIMD2> >::class_name
                            = "AFopr_CloverTerm<AField<double,SIMD2> >";

#ifdef USE_FACTORY
namespace {
  AFopr<AField<double,SIMD2> > *create_object() {
    return new AFopr_CloverTerm<AField<double,SIMD2> >();
  }

  bool init1 = AFopr<AField<double,SIMD2> >::Factory_noarg::Register(
                                          "CloverTerm", create_object);

  AFopr<AField<double,SIMD2> > *create_object_with_params(
                                      const Parameters& params) {
    return new AFopr_CloverTerm<AField<double,SIMD2> >(params);
  }
...
template class AFopr_CloverTerm<AField<double,SIMD2> >;
