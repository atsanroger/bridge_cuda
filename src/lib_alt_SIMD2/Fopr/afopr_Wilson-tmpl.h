...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson<AFIELD>::set_boundary_config(AFIELD& U,
                                                    const int mu)
{
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson<AFIELD>::mult(AFIELD &v,
                                  const AFIELD &w)
{
  if (m_mode == "D") {
    //D_alt(v, w);
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson<AFIELD>::mult_dag(AFIELD &v,
                                  const AFIELD &w)
{
  if (m_mode == "D") {
    Ddag(v, w);
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson<AFIELD>::mult_gm5(AFIELD &v,
                                  const AFIELD &w)
{
  real_t* vp = v.ptr(0);
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson<AFIELD>::D_alt(AFIELD &v, const AFIELD &w)
{
  real_t *vp = v.ptr(0);
  real_t *wp = const_cast<AFIELD*>(&w)->ptr(0);
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson<AFIELD>::H_alt(AFIELD &v,
                                   const AFIELD &w)
{
  real_t *vp = v.ptr(0);
  real_t *wp = const_cast<AFIELD*>(&w)->ptr(0);
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson<AFIELD>::mult_gm5(real_t *v,
                                      real_t *w)
{
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson<AFIELD>::mult_gm4(real_t *v, real_t *w)
{
  Index_lex_alt<real_t,AFIELD::IMPL> index;
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson<AFIELD>::gm5_aypx(real_t a, real_t *v,
                                      real_t *w,
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson<AFIELD>::aypx(real_t a, real_t *v,
                                  real_t *w,
                                  const int is, const int ns)
{
  int Ncd = m_Nvc * m_Nd;
...
#pragma omp barrier
  ...
  QYS::mult_wilson_1_dirac(buf1_xp, buf1_xm, buf1_yp, buf1_ym,
                           buf1_zp, buf1_zm, buf1_tp, buf1_tm,
                           u2, v1, &m_boundary[0], m_Nsize, do_comm);
...
#pragma omp master
 {
  ...
  // bulk
 QYS::mult_wilson_bulk_dirac(v2, u2, v1, m_CKs,
                             &m_boundary[0], m_Nsize, do_comm);
 /*
  for(int site = is; site < ns; ++site){
    int ix   = site % m_Nxv;
    int iyzt = site/m_Nxv;
...
#pragma omp barrier
  ...
  QYS::mult_wilson_2_dirac(v2, u2, v1,
