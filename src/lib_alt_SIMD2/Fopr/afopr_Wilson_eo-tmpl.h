...
const std::string AFopr_Wilson_eo<AFIELD>::class_name
                                       = "AFopr_Wilson_eo<AFIELD>";
//====================================================================
template<typename AFIELD>
void AFopr_Wilson_eo<AFIELD>::init()
{
...
#pragma omp barrier
  ...
  Index_eo_alt<real_t,SIMD2> index;
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson_eo<AFIELD>::set_boundary_config(AFIELD& U,
                                                    const int mu)
{
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson_eo<AFIELD>::mult(AFIELD &v,
                                  const AFIELD &w)
{
  if (m_mode == "D") {
    return D(v, w);
  } else if (m_mode == "mult_test") {
    return mult_test(v, w);
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson_eo<AFIELD>::mult_gm4(AFIELD &v,
                                  const AFIELD &w)
{
  real_t* vp = v.ptr(0);
  real_t* wp = const_cast<AFIELD*>(&w)->ptr(0);
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson_eo<AFIELD>::DdagD(AFIELD &v,
                                   const AFIELD &w)
{
  D(m_v2, w);
  mult_gm5(v, m_v2);
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson_eo<AFIELD>::Ddag(AFIELD &v,
                                   const AFIELD &w)
{
#pragma omp barrier
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson_eo<AFIELD>::D(AFIELD &v,
                                  const AFIELD &w)
{
  //  Meo_alt(m_v1, w, 1);
  //  Meo_alt(v, m_v1, 0);
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson_eo<AFIELD>::aypx(real_t a,
                                     AFIELD &v,
                                     const AFIELD &w)
{
  real_t* vp = v.ptr(0);
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson_eo<AFIELD>::mult_test(AFIELD &v,
                                          const AFIELD &w)
{
  real_t *vp = v.ptr(0);
  real_t *v2p = m_v2.ptr(0);
  real_t *wp = const_cast<AFIELD*>(&w)->ptr(0);
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson_eo<AFIELD>::Meo_alt(AFIELD &v,
                                      const AFIELD &w,
                                      const int ieo)
{
  real_t *vp = v.ptr(0);
...
#pragma omp barrier
  ...
  real_t *w2 = const_cast<AFIELD*>(&x)->ptr(0);
...
#pragma omp barrier
  ...
  for(int site = is; site < ns; ++site){
    ...
    if(iflag == 0){
      ...
      Vsimd_t v1v[NCD];
      load_vec(v1v, &w2[VLEN*NCD*site], NCD);
      aypx_vec(m_CKs, v2v, v1v, NCD);
      save_vec(&v2[VLEN*NCD*site], v2v, NCD);
    }
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson_eo<AFIELD>::mult_gm5(real_t *v,
                                      real_t *w)
{
  Index_eo_alt<real_t,SIMD2> index;
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson_eo<AFIELD>::mult_gm4(real_t *v,
                                         real_t *w)
{
  int ith, nth, is, ns;
  set_threadtask(ith, nth, is, ns, m_Nst2);
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson_eo<AFIELD>::aypx(real_t a, real_t *v,
                                  real_t *w,
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson_eo<AFIELD>::mult_xp(real_t *v2, real_t *v1,
                                        const int ieo)
{
  int idir = 0;
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson_eo<AFIELD>::mult_xm(real_t *v2, real_t *v1,
                                        const int ieo)
{
  int idir = 0;
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson_eo<AFIELD>::mult_yp(real_t *v2, real_t *v1,
				      const int ieo)
{
  int idir = 1;
  int Nxy2 = m_Nx2v * m_Ny;
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson_eo<AFIELD>::mult_ym(real_t *v2, real_t *v1,
				      const int ieo)
{
  int idir = 1;
  int Nxy2 = m_Nx2v * m_Ny;
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson_eo<AFIELD>::mult_zp(real_t *v2, real_t *v1,
                                        const int ieo)
{
  int idir = 2;
  int Nxy2 = m_Nx2v * m_Ny;
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson_eo<AFIELD>::mult_zm(real_t *v2, real_t *v1,
				      const int ieo)
{
  int idir = 2;
  int Nxy2 = m_Nx2v * m_Ny;
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson_eo<AFIELD>::mult_tp(real_t *v2, real_t *v1,
				      const int ieo)
{
  int idir = 3;
  int Nxyz2 = m_Nx2v * m_Ny * m_Nz;
...
//====================================================================
template<typename AFIELD>
void AFopr_Wilson_eo<AFIELD>::mult_tm(real_t *v2, real_t *v1,
				      const int ieo)
{
  int idir = 3;
  int Nxyz2 = m_Nx2v * m_Ny * m_Nz;
...
//====================================================================
template<typename AFIELD>
double AFopr_Wilson_eo<AFIELD>::flop_count()
{
  ...
  if (m_mode == "mult_test") flop = flop/2.0;
