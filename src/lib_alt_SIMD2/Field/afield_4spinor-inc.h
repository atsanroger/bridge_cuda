...
#ifndef AFIELD_4SPINOR_INC_H
#define AFIELD_4SPINOR_INC_H

#include "lib/Tools/gammaMatrix.h"

//====================================================================
template <typename REALTYPE>
void mult_Gn(AField<REALTYPE,SIMD2>& u, const int exu,
...
//====================================================================
template <typename REALTYPE>
void mult_Gd(AField<REALTYPE,SIMD2>& u, const int exu,
             const AField<REALTYPE,SIMD2>& v, const int exv,
             const AField<REALTYPE,SIMD2>& w, const int exw)
{
  typedef AField<REALTYPE,SIMD2> AFIELD;
  ...
  Index_lex_alt<real_t,SIMD2> index;
...
//====================================================================
template <typename REALTYPE>
void tensorProd_4spinor(AField<REALTYPE,SIMD2>& u, const int exu,
                        const AField<REALTYPE,SIMD2>& v, const int exv,
                        const AField<REALTYPE,SIMD2>& w, const int exw)
{
  typedef AField<REALTYPE,SIMD2> AFIELD;
...
//====================================================================
template <typename REALTYPE>
void mult_iGM(AField<REALTYPE,SIMD2>& v, const int exv,
