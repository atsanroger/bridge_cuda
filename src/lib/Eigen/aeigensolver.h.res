/*!
        ...
        @date    $LastChangedDate:: 2021-02-13 17:49:00 #$
...
class AEigensolver
{
 ...
 public:
  ...
  typedef AEigensolver *(*ProductCreator_params)(
                                FOPR *, const Parameters& params);

  typedef FactoryTemplate<AEigensolver, ProductCreator> Factory_fopr;
  typedef FactoryTemplate<AEigensolver, ProductCreator_params>
                                                 Factory_fopr_params;
  ...
  static AEigensolver *New(const IdentifierType& subtype,
