/*!
        ...
        @date    $LastChangedDate:: 2024-06-04 23:19:46 #$
...
#pragma omp master
        {
          ...
          } else if ((vv < m_Enorm_almost) &&
                     m_sorter->comp(m_TDa2[i], Vthreshold)) {
            ++Kalmost;
          }
        } // omp master
#pragma omp barrier
...
#pragma omp barrier
    ...
    for (int ik = 0; ik < Nk; ++ik) {
      ...
      vout.general(m_vl, " %4d    %20.14e    %12.4e\n",
                   ik, TDa[ik], diff2);
    }
...
//====================================================================
template<typename FIELD, typename FOPR>
void AEigensolver_IRLanczos<FIELD, FOPR>::sort_eigenmodes(
                                        std::vector<real_t>& TDa,
                                        std::vector<FIELD>& vk,
                                        std::vector<real_t>& TDa2,
                                        std::vector<FIELD>& B,
