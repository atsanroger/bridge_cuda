...
#ifndef AFOPR_SMEARED_ALT_INCLUDED
#define AFOPR_SMEARED_ALT_INCLUDED
...
class AFopr_Smeared_alt : public AFopr<AFIELD>
{
 public:
 ...
 private:
  ...
  AFopr<AFIELD> *m_fopr;
  Director_alt_Smear<AFIELD> *m_dr_smear;

 public:
  //! constructor requires Fopr and Director_Smear objects
  AFopr_Smeared_alt(AFopr<AFIELD> *fopr, Director_alt_Smear<AFIELD>* dr_smear)
    : m_fopr(fopr), m_dr_smear(dr_smear)
  { init(); }
...
private:
 ...
 private:
  static AFopr<AFIELD> *create_object(AFopr<AFIELD> *fopr,
                                      Director *director)
  {
    return new AFopr_Smeared_alt(fopr,
                 dynamic_cast<Director_alt_Smear<AFIELD> *>(director));
  }
  ...
  {
    return new AFopr_Smeared_alt(fopr,
         dynamic_cast<Director_alt_Smear<AFIELD> *>(director), params);
  }
 ...
 public:
  ...
  {
    bool                init = true;
    init &= AFopr<AFIELD>::Factory_fopr_director::Register(
                                        "Smeared_alt", create_object);
    init &= AFopr<AFIELD>::Factory_fopr_director_params::Register(
                            "Smeared_alt", create_object_with_params);
    return init;
  }
#endif
