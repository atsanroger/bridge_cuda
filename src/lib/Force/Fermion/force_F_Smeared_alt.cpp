...
template<>
const std::string AForce_F_Smeared_alt<Field>::class_name
                                      = "AForce_F_Smeared_alt<Field>";


//====================================================================
template<>
void AForce_F_Smeared_alt<Field>::init()
{
...
//====================================================================
template<>
void AForce_F_Smeared_alt<Field>::set_parameters(const Parameters& params)
{
...
//====================================================================
template<>
void AForce_F_Smeared_alt<Field>::set_config(Field *U)
{
  m_U = (Field_G *)U;
...
//====================================================================
template<>
void AForce_F_Smeared_alt<Field>::mult_jacobian(Field_G& force)
{
...
//====================================================================
template<>
void AForce_F_Smeared_alt<Field>::force_udiv(Field& force_, const Field& eta)
{
...
//====================================================================
template<>
void AForce_F_Smeared_alt<Field>::force_udiv1(Field& force_, const Field& zeta, const Field& eta)
{
  const int Nvol = CommonParameters::Nvol();
  const int Ndim = CommonParameters::Ndim();
...
template class AForce_F_Smeared_alt<Field>;
