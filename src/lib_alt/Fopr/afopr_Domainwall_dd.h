...
class AFopr_Domainwall_dd : public AFopr_dd<AFIELD>
{
 public:
  typedef AFopr<AFIELD>          AFOPR;
  typedef AFopr_dd<AFIELD>       AFOPR_DD;
 ...
 public:
  //! constructor.
  AFopr_Domainwall_dd(AFOPR *fopr) { init(fopr); }

  AFopr_Domainwall_dd(const Parameters& params) { init(params); }

  //! constructor.
  AFopr_Domainwall_dd(AFOPR *fopr, const Parameters& params)
  { init(fopr, params); }

  //! destructor.
  ~AFopr_Domainwall_dd() { tidyup(); }
 ...
 private:
  ...
  { return new AFopr_Domainwall_dd<AFIELD>(params); }

  static AFopr<AFIELD> *create_object(AFOPR *fopr)
  { return new AFopr_Domainwall_dd<AFIELD>(fopr); }

  static AFopr<AFIELD> *create_object_with_params2(AFOPR *fopr,
                                                   const Parameters& params)
  { return new AFopr_Domainwall_dd<AFIELD>(fopr, params); }
 ...
 public:
  static bool register_factory()
  {
    ...
    init &= AFOPR::Factory_fopr::Register(
      "Domainwall_dd", create_object);

    init &= AFOPR::Factory_fopr_params::Register(
      "Domainwall_dd", create_object_with_params2);
