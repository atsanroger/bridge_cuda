/*!
      @file    afopr_Domainwall_dd-tmpl.h
      @brief
...
const std::string AFopr_Domainwall_dd<AFIELD>::class_name
  = "AFopr_Domainwall_dd";
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::init(const Parameters& params)
{
  ...
  m_foprw = (AFopr_dd<AFIELD>*)AFopr<AFIELD>::New(m_kernel_type, params_kernel);
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::init(AFOPR *fopr,
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::tidyup()
{
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::set_parameters(const Parameters& params)
{
  std::string vlevel;
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::get_parameters(Parameters& params) const
{
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::set_parameters(
  const real_t mq,
  const real_t M0,
  const int Ns,
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::set_coefficients(
  const std::vector<real_t> vec_b,
  const std::vector<real_t> vec_c)
{
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::set_kernel_parameters(
  const Parameters& params)
{
  Parameters params_kernel = params;
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::set_precond_parameters()
{
  if (m_dp.size() != m_Ns) {
    m_dp.resize(m_Ns);
    m_dm.resize(m_Ns);
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::convert(AFIELD& v, const Field& w)
{
  if (!needs_convert()) {
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::reverse(Field& v, const AFIELD& w)
{
  if (!needs_convert()) {
    vout.crucial(m_vl, "%s: convert is not necessary.\n",
                 class_name.c_str());
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::set_mode(std::string mode)
{
#pragma omp barrier
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::mult(AFIELD& v, const AFIELD& w)
{
  if (m_mode == "D") {
    D(v, w);
  } else if (m_mode == "Ddag") {
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::mult_dag(AFIELD& v, const AFIELD& w)
{
  if (m_mode == "D") {
    Ddag(v, w);
  } else if (m_mode == "Ddag") {
                                        ...
                                        std::string mode)
{
  ...
  if (mode == "Prec") {
    ...
    std::cout << "mode undeifined in AFopr_Domainwall_dd.\n";
    abort();
  }
}
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::mult_sap(AFIELD& v, const AFIELD& w,
                                           const int ieo)
{
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::mult_dd(AFIELD& v, const AFIELD& w)
{
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::mult_dup(AFIELD& v, const AFIELD& w,
                                           const int mu)
{
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::mult_ddn(AFIELD& v, const AFIELD& w,
                                           const int mu)
{
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::mult_gm5(AFIELD& v, const AFIELD& w)
{
  int Nex = w.nex();
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::mult_chproj_4d(AFIELD& v,
                                              const AFIELD& w,
                                              const int ipm)
{
#pragma omp barrier
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::mult_gm5_4d(AFIELD& v, const AFIELD& w)
{
  m_foprw->mult_gm5(v, w);
}
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::DdagD(AFIELD& v, const AFIELD& w)
{
  assert(w.check_size(m_NinF, m_Nvol, m_Ns));
  assert(v.check_size(m_NinF, m_Nvol, m_Ns));
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::DDdag(AFIELD& v, const AFIELD& w)
{
  assert(w.check_size(m_NinF, m_Nvol, m_Ns));
  assert(v.check_size(m_NinF, m_Nvol, m_Ns));
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::DdagD_prec(AFIELD& v, const AFIELD& w)
{
  assert(w.check_size(m_NinF, m_Nvol, m_Ns));
  assert(v.check_size(m_NinF, m_Nvol, m_Ns));
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::D_prec(AFIELD& v, const AFIELD& w)
{
  L_inv(v, w);
  U_inv(m_v2, v);
  D(v, m_v2);
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::Ddag_prec(AFIELD& v, const AFIELD& w)
{
  Ddag(v, w);
  Udag_inv(m_v2, v);
  Ldag_inv(v, m_v2);
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::Prec(AFIELD& v, const AFIELD& w)
{
  L_inv(m_v2, w);
  U_inv(v, m_v2);
}
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::Precdag(AFIELD& v, const AFIELD& w)
{
  Udag_inv(m_v2, w);
  Ldag_inv(v, m_v2);
}
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::H(AFIELD& v, const AFIELD& w)
{
  D(m_v2, w);
  mult_gm5R(v, m_v2);
}
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::Hdag(AFIELD& v, const AFIELD& w)
{
  mult_gm5R(m_v2, w);
  Ddag(v, m_v2);
}
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::mult_gm5R(AFIELD& v, const AFIELD& w)
{
#pragma omp barrier
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::mult_R(AFIELD& v, const AFIELD& w)
{
  assert(w.check_size(m_NinF, m_Nvol, m_Ns));
  assert(v.check_size(m_NinF, m_Nvol, m_Ns));
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::D(AFIELD& v, const AFIELD& w)
{
#pragma omp barrier
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::Ddag(AFIELD& v, const AFIELD& w)
{
#pragma omp barrier
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::L_inv(AFIELD& v, const AFIELD& w)
{
#pragma omp barrier
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::U_inv(AFIELD& v, const AFIELD& w)
{
  v.set(0.0);
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::Udag_inv(AFIELD& v, const AFIELD& w)
{
#pragma omp barrier
...
//====================================================================
template<typename AFIELD>
void AFopr_Domainwall_dd<AFIELD>::Ldag_inv(AFIELD& v, const AFIELD& w)
{
  int is = m_Ns - 1;
...
//====================================================================
template<typename AFIELD>
double AFopr_Domainwall_dd<AFIELD>::flop_count(std::string mode)
{
...
//====================================================================
template<typename AFIELD>
double AFopr_Domainwall_dd<AFIELD>::flop_count_sap()
{
  // not yet implemented.
  return 0.0;
