...
namespace Test_HMC_Wilson {
  const std::string test_name = "HMC.Wilson_eo_ratio.Nf2";

  //- test-private parameters
  namespace {
    const std::string filename_input = "test_HMC_Wilson_Nf2_alt_eo_ratio.yaml";
  }
  ...
  int update_Nf2_alt_eo_ratio(void)
  {
    ...
    actions.append(level_action[1], action_F1.get());
