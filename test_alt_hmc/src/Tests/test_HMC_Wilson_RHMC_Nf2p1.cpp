/*!
        @file    test_HMC_Wilson_RHMC_Nf2p1.cpp
...
namespace Test_HMC_Wilson {
  const std::string test_name = "HMC.Wilson.RHMC_Nf2p1";

  //- test-private parameters
  namespace {
    const std::string filename_input = "test_HMC_Wilson_RHMC_Nf2p1.yaml";
  }
  ...
  int RHMC_Nf2p1(void)
  {
    ...
    unique_ptr<Force> force_fopr_Nf2(new Force_F_Wilson_Nf2(params_fopr_Nf2));
    ...
    unique_ptr<Force> force_fopr_Nf2_prec(new Force_F_Wilson_Nf2(params_fopr_Nf2_prec));
    ...
    unique_ptr<Force> force_fopr_Nf1(new Force_F_Wilson_Nf2(params_fopr_Nf1));
