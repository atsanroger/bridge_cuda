...
namespace Test_HMC_Domainwall {
  ...
  namespace {
    const std::string filename_input = "test_HMC_Domainwall_Nf2_PV_alt.yaml";
  }

  //- prototype declaration
  int update_Nf2_PV_Field(void);
  ...
  int update_Nf2_PV_alt_Field(void)
  {
    ...
    */
    ...
    unique_ptr<Fopr>  fopr_smear(Fopr::New("Smeared_alt", fopr_dw.get(), dr_smear.get()));
    unique_ptr<Force> force_fopr_smear(
      new AForce_F_Smeared_alt<AFIELD>(force_fopr_dw.get(), dr_smear.get()));
    ...
    unique_ptr<Fopr>  fopr_smear_pv(Fopr::New("Smeared_alt", fopr_dw_pv.get(), dr_smear.get()));
    unique_ptr<Force> force_fopr_smear_pv(new AForce_F_Smeared_alt<AFIELD>(force_fopr_dw_pv.get(), dr_smear.get()));
